...
function init(){
	...
	document.getElementById('eggDetails').addEventListener("click", togglePopup, false);
	document.getElementById('crackDetails').addEventListener("click", togglePopup, false);
	document.getElementById('chickDetails').addEventListener("click", togglePopup, false);
	document.getElementById('roosterDetails').addEventListener("click", togglePopup, false);
...
/*Functions*/
	...
	function togglePopup(event){
		if (popupOpen){
			...
			if(event.target.id=="echantillonSignButton"){
				...
				popupOpen = true;
				showPopup("delf");
			} else if (event.target.id=="eggDetails"){
				popupOpen = true;
				showPopup("egg");
			} else if (event.target.id=="crackDetails"){
				popupOpen = true;
				showPopup("crack");
			} else if (event.target.id=="chickDetails"){
				popupOpen = true;
				showPopup("chick");
			} else if (event.target.id=="roosterDetails"){
				popupOpen = true;
				showPopup("rooster");
			}
		}
	...
	function lessonUpdate(event){
		...
		if (button == "privateSelect" || button == "privateDiv"){
			...
			document.getElementById("delfSelect").style.borderBottom="3px solid white";
		}
	}
	...
	function tcontentUpdate(set){
		if (set=="n1"){
			document.getElementById("tableArea").innerHTML = "<div id=\'wrapper\'>\n<p>[Not stated on site]</p>\n</div>";
		} else if (set=="n2"){
			document.getElementById("tableArea").innerHTML = "<div id=\'wrapper\'>\n<p>*Due to the Queen\'s Birthday public holiday on Monday 8th June, there will be no classes on this day. Catch up classes are scheduled for Friday 5th June.</p>\n<table class=\'timetable\'>\n<tr>\n<td></td>\n<td class=\'yellowGroup\' colspan=\'2\'><p><strong>key course</strong> (6 weeks) from.\n20/04 to 30/05</p></td>\n<td class=\'yellowGroup\' ><p><strong>speaking practice</strong> (4 weeks) from 01/06\nto 27/06</p></td>\n</tr>\n<tr>\n<td class=\'egg\'>1</td>\n<td class=\'blueEgg\'><p>Thursday 6.15PM</p></td>\n<td class=\'blueEgg\'><p>from 23/04</p></td>\n<td class=\'blueDash\'><p>from 04/06</p></td>\n</tr>\n<tr>\n<td class=\'egg\'>1</td>\n<td class=\'blueEgg\'><p>Saturday 8.45AM</p></td>\n<td class=\'blueEgg\'><p>from 25/04</p></td>\n<td class=\'blueDash\'><p>from 06/06</p></td>\n</tr>\n<tr>\n<td class=\'egg\'>2</td>\n<td class=\'blueEgg\'><p>Tuesday 6.15PM</p></td>\n<td class=\'blueEgg\'><p>from 21/04</p></td>\n<td class=\'blueDash\'><p>from 02/06</p></td>\n</tr>\n<tr>\n<td class=\'egg\'>2</td>\n<td class=\'blueEgg\'><p>Saturday 10AM</p></td>\n<td class=\'blueEgg\'><p>from 25/04</p></td>\n<td class=\'blueDash\'><p>from 06/06</p></td>\n</tr>\n<tr>\n<td class=\'egg\'>3</td>\n<td class=\'blueEgg\'><p>Tuesday 7.30PM</p></td>\n<td class=\'blueEgg\'><p>from 21/04</p></td>\n<td class=\'blueDash\'><p>from 02/06</p></td>\n</tr>\n<tr>\n<td class=\'crack\'>1</td>\n<td class=\'greyCrack\'><p>Tuesday 7.30PM</p></td>\n<td class=\'greyCrack\'><p>from 21/04</p></td>\n<td class=\'greyDash\'><p>from 02/06</p></td>\n</tr>\n<tr>\n<td class=\'crack\'>2</td>\n<td class=\'greyCrack\'><p>Wednesday 6.15PM</p></td>\n<td class=\'greyCrack\'><p>from 22/04</p></td>\n<td class=\'greyDash\'><p>from 03/06</p></td>\n</tr>\n<tr>\n<td class=\'chick\'>1</td>\n<td class=\'greyChick\'><p>Tuesday 6.15PM</p></td>\n<td class=\'greyChick\'><p>from 21/04</p></td>\n<td class=\'greyCDash\'><p>from 02/06</p></td>\n</tr>\n<tr>\n<td class=\'chick\'>2</td>\n<td class=\'greyChick\'><p>Thursday 10AM</p></td>\n<td class=\'greyChick\'><p>from 23/04</p></td>\n<td class=\'greyCDash\'><p>from 04/06</p></td>\n</tr>\n<tr>\n<td class=\'rooster\'>1</td>\n<td class=\'redRooster\'><p>Thursday 7.30PM</p></td>\n<td class=\'redRooster\'><p>from 21/04</p></td>\n<td class=\'redDash\'><p>from 04/06</p></td>\n</tr>\n<tr>\n<td class=\'rooster\'></td>\n<td class=\'redRooster\' colspan=\'2\'><p>Thursday 6.15PM : Conversation</p></td>\n<td class=\'redRooster\'><p>from 23/04</p></td>\n</tr>\n<tr>\n<td></td>\n<td></td>\n<td></td>\n</tr>\n<tr>\n<td></td>\n<td class=\'yellowGroup\' colspan=\'3\'><p><strong>consolidation course</strong> (10\nweeks) <br> from 20/04 to 27/06</p></td>\n</tr>\n<tr>\n<td class=\'chick\'>C</td>\n<td class=\'greyChick\' colspan=\'2\'><p>Monday 7.30PM</p></td>\n<td class=\'greyChick\'><p>from 20/04</p></td>\n</tr>\n<tr>\n<td class=\'rooster\'>C</td>\n<td class=\'redRooster\' colspan=\'2\'><p>Monday 7.30PM</p></td>\n<td class=\'redRooster\'><p>from 20/04</p></td>\n</tr>\n</table>\n</div>";
		} else if (set=="n3"){
			document.getElementById("tableArea").innerHTML = "<div id=\'wrapper\'>\n<p>*Due to the EKKA Day public holiday on Wednesday 12th August, there will be no classes on this day. Catch up classes are scheduled for Friday 14th August.</p>\n<table class=\'timetable\'>\n<tr>\n<td></td>\n<td class=\'yellowGroup\' colspan=\"2\"><p><strong>key course</strong> (6 weeks) from. 13/07 to 22/08</p></td>\n<td class=\'yellowDash\'><p><strong>speaking practice</strong> (4 weeks) from 24/08 to 19/09</p></td>\n</tr>\n<tr>\n<td class=\'egg\'><div>1</div></td>\n<td class=\'blueEgg\'><p>Wednesday 7.30PM</p></td>\n<td class=\'blueEgg\'><p>from 15/07</p></td>\n<td class=\'blueDash\'><p>from 26/08</p></td>\n</tr>\n<tr>\n<td class=\'egg\'><div>1</div></td>\n<td class=\'blueEgg\'><p>Thursday 6.15PM</p></td>\n<td class=\'blueEgg\'><p>from 16/07</p></td>\n<td class=\'blueDash\'><p>from 27/08</p></td>\n</tr>\n<tr>\n<td class=\'egg\'><div>1</div></td>\n<td class=\'blueEgg\'><p>Saturday 10AM</p></td>\n<td class=\'blueEgg\'><p>from 18/07</p></td>\n<td class=\'blueDash\'><p>from 29/08</p></td>\n</tr>\n<tr>\n<td class=\'egg\'><div>2</div></td>\n<td class=\'blueEgg\'><p>Saturday 8.45AMPM</p></td>\n<td class=\'blueEgg\'><p>from 18/07</p></td>\n<td class=\'blueDash\'><p>from 29/08</p></td>\n</tr>\n<tr>\n<td class=\'egg\'><div>3</div></td>\n<td class=\'blueEgg\'><p>Tuesday 6.15PM</p></td>\n<td class=\'blueEgg\'><p>from 1r/07</p></td>\n<td class=\'blueDash\'><p>from 25/08</p></td>\n</tr>\n<tr>\n<td class=\'egg\'><div>R</div></td>\n<td class=\'blueEgg\'><p>Tuesday 7.30PM</p></td>\n<td class=\'blueEgg\'><p>from 14/07</p></td>\n<td class=\'blueDash\'><p>from 25/08</p></td>\n</tr>\n<tr>\n<td class=\'crack\'><div>2</div></td>\n<td class=\'greyCrack\'><p>Tuesday 7.30PM</p></td>\n<td class=\'greyCrack\'><p>from 14/07</p></td>\n<td class=\'greyDash\'><p>from 25/08</p></td>\n</tr>\n<tr>\n<td class=\'crack\'><div>3</div></td>\n<td class=\'greyCrack\'><p>Wednesday 6.15PM</p></td>\n<td class=\'greyCrack\'><p>from 15/07</p></td>\n<td class=\'greyDash\'><p>from 26/08</p></td>\n</tr>\n<tr>\n<td class=\'chick\'><div>2</div></td>\n<td class=\'greyChick\'><p>Tuesday 6.15PM</p></td>\n<td class=\'greyChick\'><p>from 14/07</p></td>\n<td class=\'greyCDash\'><p>from 25/08</p></td>\n</tr>\n<tr>\n<td class=\'chick\'><div>3</div></td>\n<td class=\'greyChick\'><p>Thursday 10AM</p></td>\n<td class=\'greyChick\'><p>from 16/07</p></td>\n<td class=\'greyCDash\'><p>from 27/08</p></td>\n</tr>\n<tr>\n<td class=\'rooster\'><div>2</div></td>\n<td class=\'redRooster\'><p>Thursday 7.30PM</p></td>\n<td class=\'redRooster\'><p>from 16/07</p></td>\n<td class=\'redDash\'><p>from 27/08</p></td>\n</tr>\n<tr>\n<td class=\'rooster\'><div></div></td>\n<td class=\'redRooster\' colspan=\"2\"><p>Thursday 6.15PM : Conversation</p></td>\n<td class=\'redRooster\'><p>from 16/07</p></td>\n</tr>\n<tr>\n<td></td>\n<td></td>\n<td></td>\n</tr>\n<tr>\n<td></td>\n<td class=\'yellowGroup\' colspan=\"3\"><p><strong>consolidation course</strong> (10 weeks) <br> from 13/07 to 19/09</p></td>\n</tr>\n<tr>\n<td class=\'crack\'><div>C</div></td>\n<td class=\'greyCrack\' colspan=\"2\"><p>Monday 6.15PM</p></td>\n<td class=\'greyCrack\'><p>from 13/07</p></td>\n</tr>\n<tr>\n<td class=\'chick\'><div>C</div></td>\n<td class=\'greyChick\' colspan=\"2\"><p>Monday 7.30PM</p></td>\n<td class=\'greyChick\'><p>from 13/07</p></td>\n</tr>\n<tr>\n<td class=\'rooster\'><div>C</div></td>\n<td class=\'redRooster\' colspan=\"2\"><p>Monday 6.15PM</p></td>\n<td class=\'redRooster\'><p>from 13/07</p></td>\n</tr>\n</table>\n</div>";
		} else if (set=="n4"){
			document.getElementById("tableArea").innerHTML = "<div id=\'wrapper\'>\n<p>*Due to the Labour Day on Monday 5th October, there will be no classes on this day. Catch up classes are scheduled for Friday 9th October.</p>\n<table class=\'timetable\'>\n<tr>\n<tr>\n<td></td>\n<td class=\'yellowGroup\' colspan=\"2\"><p><strong>key course</strong> (6 weeks) from. 05/10 to 14/11</p></td>\n<td class=\'yellowDash\'><p><strong>speaking practice</strong> (4 weeks) from 16/11 to 12/12</p></td>\n</tr>\n<tr>\n<td class=\'egg\'><div>1</div></td>\n<td class=\'blueEgg\'><p>Tuesday 6.15PM</p></td>\n<td class=\'blueEgg\'><p>from 06/10</p></td>\n<td class=\'blueDash\'><p>from 17/11</p></td>\n</tr>\n<tr>\n<td class=\'egg\'><div>1</div></td>\n<td class=\'blueEgg\'><p>Thursday 7.30PM</p></td>\n<td class=\'blueEgg\'><p>from 08/10</p></td>\n<td class=\'blueDash\'><p>from 19/11</p></td>\n</tr>\n<tr>\n<td class=\'egg\'><div>1</div></td>\n<td class=\'blueEgg\'><p>Saturday 8.45AM</p></td>\n<td class=\'blueEgg\'><p>from 10/10</p></td>\n<td class=\'blueDash\'><p>from 21/11</p></td>\n</tr>\n<tr>\n<td class=\'egg\'><div>2</div></td>\n<td class=\'blueEgg\'><p>Tuesday 7.30PM</p></td>\n<td class=\'blueEgg\'><p>from 06/10</p></td>\n<td class=\'blueDash\'><p>from 17/11</p></td>\n</tr>\n<tr>\n<td class=\'egg\'><div>2</div></td>\n<td class=\'blueEgg\'><p>Thursday 6.15PM</p></td>\n<td class=\'blueEgg\'><p>from 08/10</p></td>\n<td class=\'blueDash\'><p>from 19/11</p></td>\n</tr>\n<tr>\n<td class=\'egg\'><div>2</div></td>\n<td class=\'blueEgg\'><p>Saturday 10AM</p></td>\n<td class=\'blueEgg\'><p>from 10/10</p></td>\n<td class=\'blueDash\'><p>from 21/11</p></td>\n</tr>\n<tr>\n<td class=\'egg\'><div>3</div></td>\n<td class=\'blueEgg\'><p>Wednesday 7.30PM</p></td>\n<td class=\'blueEgg\'><p>from 07/10</p></td>\n<td class=\'blueDash\'><p>from 18/11</p></td>\n</tr>\n<tr>\n<td class=\'egg\'><div>R</div></td>\n<td class=\'blueEgg\'><p>Tuesday 10AM</p></td>\n<td class=\'blueEgg\'><p>from 06/10</p></td>\n<td class=\'blueDash\'><p>from 17/11</p></td>\n</tr>\n<tr>\n<td class=\'egg\'><div>R</div></td>\n<td class=\'blueEgg\'><p>Tuesday 6.15PM</p></td>\n<td class=\'blueEgg\'><p>from 06/10</p></td>\n<td class=\'blueDash\'><p>from 17/11</p></td>\n</tr>\n<tr>\n<td class=\'egg\'><div>R</div></td>\n<td class=\'blueEgg\'><p>Wednesday 7.30PM</p></td>\n<td class=\'blueEgg\'><p>from 07/10</p></td>\n<td class=\'blueDash\'><p>from 18/11</p></td>\n</tr>\n<tr>\n<td class=\'crack\'><div>1</div></td>\n<td class=\'greyCrack\'><p>Tuesday 7.30PM</p></td>\n<td class=\'greyCrack\'><p>from 06/10</p></td>\n<td class=\'greyDash\'><p>from 17/11</p></td>\n</tr>\n<tr>\n<td class=\'crack\'><div>2</div></td>\n<td class=\'greyCrack\'><p>Tuesday 7.30PM</p></td>\n<td class=\'greyCrack\'><p>from 06/10</p></td>\n<td class=\'greyDash\'><p>from 17/11</p></td>\n</tr>\n<tr>\n<td class=\'crack\'><div>3</div></td>\n<td class=\'greyCrack\'><p>Thursday 7.30PM</p></td>\n<td class=\'greyCrack\'><p>from 08/10</p></td>\n<td class=\'greyDash\'><p>from 19/11</p></td>\n</tr>\n<tr>\n<td class=\'crack\'><div>R</div></td>\n<td class=\'greyCrack\'><p>Wednesday 6.15PM</p></td>\n<td class=\'greyCrack\'><p>from 07/10</p></td>\n<td class=\'greyDash\'><p>from 18/11</p></td>\n</tr>\n<tr>\n<td class=\'chick\'><div>1</div></td>\n<td class=\'greyChick\'><p>Wednesday 7.30PM</p></td>\n<td class=\'greyChick\'><p>from 07/10</p></td>\n<td class=\'greyCDash\'><p>from 18/11</p></td>\n</tr>\n<tr>\n<td class=\'chick\'><div>3</div></td>\n<td class=\'greyChick\'><p>Tuesday 6.15PM</p></td>\n<td class=\'greyChick\'><p>from 06/10</p></td>\n<td class=\'greyCDash\'><p>from 17/11</p></td>\n</tr>\n<tr>\n<td class=\'chick\'><div>R</div></td>\n<td class=\'greyChick\'><p>Thursday 10AM</p></td>\n<td class=\'greyChick\'><p>from 08/10</p></td>\n<td class=\'greyCDash\'><p>from 19/11</p></td>\n</tr>\n<tr>\n<td class=\'rooster\'><div>2</div></td>\n<td class=\'redRooster\'><p>Wednesday 6.15PM</p></td>\n<td class=\'redRooster\'><p>from 07/10</p></td>\n<td class=\'redDash\'><p>from 18/11</p></td>\n</tr>\n<tr>\n<td class=\'rooster\'><div>3</div></td>\n<td class=\'redRooster\'><p>Thursday 7.30PM</p></td>\n<td class=\'redRooster\'><p>from 08/10</p></td>\n<td class=\'redDash\'><p>from 19/11</p></td>\n</tr>\n<tr>\n<td></td>\n<td></td>\n<td></td>\n</tr>\n<tr>\n<td><div></div></td>\n<td class=\'yellowGroup\' colspan=\"3\"><p>Thursday 6.15PM : Conversation</p></td>\n</tr>\n<tr>\n<td class=\'crack\'><div>C</div></td>\n<td class=\'greyCrack\' colspan=\"2\"><p>Monday 6.15PM*</p></td>\n<td class=\'greyCrack\'><p>from 05/10*</p></td>\n</tr>\n<tr>\n<td class=\'chick\'><div>C</div></td>\n<td class=\'greyChick\' colspan=\"2\"><p>Monday 7.30PM*</p></td>\n<td class=\'greyChick\'><p>from 05/10*</p></td>\n</tr>\n<tr>\n<td class=\'rooster\'><div>C</div></td>\n<td class=\'redRooster\' colspan=\"2\"><p>Monday 6.15PM*</p></td>\n<td class=\'redRooster\'><p>from 05/10*</p></td>\n</tr>\n</table>\n</div>";
		} else if (set=="b1"){
			document.getElementById("tableArea").innerHTML ="<div id=\'wrapper\'>\n<p>[Not stated on site]</p>\n</div>";
		} else if (set=="b2"){
			document.getElementById("tableArea").innerHTML = "<div id=\'wrapper\'>\n<p>*Due to the Queen\'s Birthday public holiday on Monday 8th June, there will be no classes on this day. Catch up classes are scheduled for Friday 5th June.</p>\n<table class=\'timetable\'>\n<tr>\n<td></td>\n<td class=\'yellowGroup\' colspan=\'2\'><p><strong>key course</strong> (6 weeks) from. 20/04 to 30/05</p></td>\n<td class=\'yellowDash\'><p><strong>speaking practice</strong> (4 weeks) from 01/06 to 27/06</p></td>\n</tr>\n<tr>\n<td class=\'egg\'><div>3</div></td>\n<td class=\'blueEgg\'><p>Thursday 6.15PM</p></td>\n<td class=\'blueEgg\'><p>from 23/04</p></td>\n<td class=\'blueDash\'><p>from 04/06</p></td>\n</tr>\n<tr>\n<td class=\'crack\'><div>1</div></td>\n<td class=\'greyCrack\'><p>Thursday 7.30PM</p></td>\n<td class=\'greyCrack\'><p>from 23/04</p></td>\n<td class=\'greyDash\'><p>from 04/06</p></td>\n</tr>\n</table>\n</div>";
		} else if (set=="b3"){
			document.getElementById("tableArea").innerHTML = "<div id=\'wrapper\'>\n<p>*Due to the EKKA Day public holiday on Wednesday 12th August, there will be no classes on this day. Catch up classes are scheduled for Friday 14th August.</p>\n<table class=\'timetable\'>\n<tr>\n<td></td>\n<td class=\'yellowGroup\' colspan=\"2\"><p><strong>key course</strong> (6 weeks) from. 13/07 to 21/08</p></td>\n<td class=\'yellowDash\'><p><strong>speaking practice</strong> (4 weeks) from 24/08 to 19/09</p></td>\n</tr>\n<tr>\n<td class=\'egg\'><div>1</div></td>\n<td class=\'blueEgg\'><p>Thursday 6.15PM</p></td>\n<td class=\'blueEgg\'><p>from 16/07</p></td>\n<td class=\'blueDash\'><p>from 27/08</p></td>\n</tr>\n<tr>\n<td class=\'egg\'><div>R</div></td>\n<td class=\'blueEgg\'><p>Thursday 6.15PM</p></td>\n<td class=\'blueEgg\'><p>from 16/07</p></td>\n<td class=\'blueDash\'><p>from 27/08</p></td>\n</tr>\n<tr>\n<td class=\'crack\'><div>2</div></td>\n<td class=\'greyCrack\'><p>Thursday 7.30PM</p></td>\n<td class=\'greyCrack\'><p>from 16/07</p></td>\n<td class=\'greyDash\'><p>from 27/08</p></td>\n</tr>\n</table>\n</div>";
		} else if (set=="b4"){
			document.getElementById("tableArea").innerHTML = "<div id=\'wrapper\'>\n<p>*Due to the Labour Day on Monday 5th October, there will be no classes on this day. Catch up classes are scheduled for Friday 9th October.</p>\n<table class=\'timetable\'>\n<tr>\n<td></td>\n<td class=\'yellowGroup\' colspan=\"2\"><p><strong>key course</strong> (6 weeks) from. 05/10 to 14/11</p></td>\n<td class=\'yellowDash\'><p><strong>speaking practice</strong> (4 weeks) from 16/11 to 12/12</p></td>\n</tr>\n<tr>\n<td class=\'egg\'><div>1</div></td>\n<td class=\'blueEgg\'><p>Thursday 6.15PM</p></td>\n<td class=\'blueEgg\'><p>from 08/10</p></td>\n<td class=\'blueDash\'><p>from 19/11</p></td>\n</tr>\n<tr>\n<td class=\'egg\'><div>1</div></td>\n<td class=\'blueEgg\'><p>Thursday 7.30PM</p></td>\n<td class=\'blueEgg\'><p>from 08/10</p></td>\n<td class=\'blueDash\'><p>from 19/11</p></td>\n</tr>\n<tr>\n<td class=\'egg\'><div>3</div></td>\n<td class=\'blueEgg\'><p>Thursday 6.15PM</p></td>\n<td class=\'blueEgg\'><p>from 08/10</p></td>\n<td class=\'blueDash\'><p>from 19/11</p></td>\n</tr>\n<tr>\n<td class=\'egg\'><div>R</div></td>\n<td class=\'blueEgg\'><p>Thursday 7.30PM</p></td>\n<td class=\'blueEgg\'><p>from 08/10</p></td>\n<td class=\'blueDash\'><p>from 19/11</p></td>\n</tr>\n</table>\n</div>";
		} else if (set=="p1"){
			document.getElementById("tableArea").innerHTML="<div id=\'wrapper\'>\n<p>[Not stated on site]</p>\n</div>";
		} else if (set=="p2"){
			document.getElementById("tableArea").innerHTML = "<div id=\'wrapper\'>\n<p>*Due to the Queen\'s Birthday public holiday on Monday 8th June, there will be no classes on this day. Catch up classes are scheduled for Friday 5th June.</p>\n<table class=\'timetable\'>\n<tr>\n<td></td>\n<td class=\'yellowGroup\' colspan=\"2\"><p><strong>key course</strong> (6 weeks) from. 20/04 to 30/05</p></td>\n<td class=\'yellowDash\'><p><strong>speaking practice</strong> (4 weeks) from 01/06 to 27/06</p></td>\n</tr>\n<tr>\n<td class=\'egg\'><div>1</div></td>\n<td class=\'blueEgg\'><p>Wednesday 6.15PM</p></td>\n<td class=\'blueEgg\'><p>from 22/04</p></td>\n<td class=\'blueDash\'><p>from 03/06</p></td>\n</tr>\n</table>\n</div>";
		} else if (set=="p3"){
			document.getElementById("tableArea").innerHTML = "<div id=\'wrapper\'>\n<p>*Due to the EKKA Day public holiday on Wednesday 12th August, there will be no classes on this day. Catch up classes are scheduled for Friday 14th August.</p>\n<table class=\'timetable\'>\n<tr>\n<td></td>\n<td class=\'yellowGroup\' colspan=\"2\"><p><strong>key course</strong> (6 weeks) from. 13/07 to 21/08</p></td>\n<td class=\'yellowDash\'><p><strong>speaking practice</strong> (4 weeks) from 24/08 to 19/09</p></td>\n</tr>\n<tr>\n<td class=\'egg\'><div>2</div></td>\n<td class=\'blueEgg\'><p>Wednesday 6.15PM</p></td>\n<td class=\'blueEgg\'><p>from 15/07</p></td>\n<td class=\'blueDash\'><p>from 26/08</p></td>\n</tr>\n<tr>\n<td class=\'egg\'><div>1</div></td>\n<td class=\'blueEgg\'><p>Wednesday 7.30PM</p></td>\n<td class=\'blueEgg\'><p>from 15/07</p></td>\n<td class=\'blueDash\'><p>from 26/08</p></td>\n</tr>\n</table>\n</div>";
		} else if (set=="p4"){
			document.getElementById("tableArea").innerHTML = "<div id=\'wrapper\'>\n<p>No lessons.</p>\n</div>";
		}
		document.getElementById("tableArea").style.height=String(document.getElementById("wrapper").offsetHeight+20)+"px";

		setTimeout(function(){
			console.log(document.getElementById("group").offsetHeight);
			document.getElementById("lessonsContent").style.height=String(document.getElementById("group").offsetHeight+140)+"px";
		},1000)
	}
	...
	function wcontentUpdate(set){
		if (set=="nj"){
			document.getElementById("workArea").innerHTML = "<div id=\'wrapper2\'>\n<table class='workshop'>\n<tr>\n<td  class=\'yellowGroup\' colspan=\"2\"><strong>workshops</strong> (2 weeks)</td>\n</tr>\n<tr>\n<td class=\'pinkGroup\'>pronunciation</td>\n<td class=\'pinkGroup\'><strong>Tuesday 6.15PM - 8.15PM 30/06 - 07/07</strong></td>\n</tr>\n<tr>\n<td class=\'redGroup\'>travel</td>\n<td class=\'redGroup\'>Wednesay 6.15PM - 8.15PM 01/07 - 07/07</td>\n</tr>\n</table>\n</div>";
		} else if (set=="ns"){
			document.getElementById("workArea").innerHTML = "<div id=\'wrapper2\'>\n<table class='workshop'>\n<tr>\n<td class=\'yellowGroup\' colspan=\"2\"><strong>workshops</strong> (2 weeks)</td>\n</tr>\n<tr>\n<td class=\'redGroup\'>travel</td>\n<td class=\'redGroup\'><strong>Tuesday 6.15PM - 8.15PM 22/09 - 29/09</strong></td>\n</tr>\n<tr>\n<td class=\'blueGroup\'>little words</td>\n<td class=\'blueGroup\'><strong>Wednesay 6.15PM - 8.15PM 23/09 - 30/09</strong></td>\n</tr>\n</table>";
		} else if (set=="bj"){
			document.getElementById("workArea").innerHTML = "<div id=\'wrapper2\'>\n<table class='workshop'>\n<tr>\n<td class=\'yellowGroup\' colspan=\"2\"><strong>workshops</strong> (2 weeks)</td>\n</tr>\n<tr>\n<td class=\'redGroup\'>travel</td>\n<td class=\'redGroup\'><strong>Tuesday 6.15PM - 8.15PM 22/09 - 29/09</strong></td>\n</tr>\n<tr>\n<td class=\'blueGroup\'>little words</td>\n<td class=\'blueGroup\'><strong>Wednesay 6.15PM - 8.15PM 23/09 - 30/09</strong></td>\n</tr>\n</table>\n</div>";
		} else if (set=="bs"){
			document.getElementById("workArea").innerHTML = "<div id=\'wrapper2\'>\n<table class='workshop'>\n<tr>\n<td class=\'yellowGroup\' colspan=\"2\"><strong>workshops</strong> (2 weeks)</td>\n</tr>\n<tr>\n<td class=\'blueGroup\'>little words</td>\n<td class=\'blueGroup\'><strong>Thursday 6.15PM - 8.15PM 24/09 - 01/10</strong></td>\n</tr>\n</table>\n</div>";
		}
		document.getElementById("workArea").style.height=String(document.getElementById("wrapper2").offsetHeight+20)+"px";
